...
public class Globals {
    ...
    static final Direction[] ALL_DIRS = new Direction[] {
            Direction.CENTER,
            Direction.NORTH,
            Direction.NORTHEAST,
            Direction.EAST,
    ...
    static final int MAX_ALIVE_RATS = 16; // TODO: Decide on final max alive count
    ...
    static final int MAX_CHEESE_CARRIED_NEAR_KING = 100;
    static final int MAX_CHEESE_CARRIED = 60;
    ...
    // Attack Opportunity
    static final int HEURISTIC_RATNAP_BONUS = 40;
